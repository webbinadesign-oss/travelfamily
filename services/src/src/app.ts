...
export function createApp(): Application {
  ...
  // Serve the RAW Prototype (no bundler wrapper → no "[bundle] error" overlay)
  // over HTTPS, so the family demo runs in a SECURE context (required for the
  // microphone / getUserMedia). Files live in public/app/ (index.html + assets/).
